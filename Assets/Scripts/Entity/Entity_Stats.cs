...
public class Entity_Stats : MonoBehaviour
{
    ...
    public Stat_OffenseGroup offensive;
    public Stat_DefenseGroup defense;
    public Stat_MajorGroup major;

    public float GetElementalDamage(out ElementType element, float scaleFactor)
    {
        float fireDamage = offensive.fireDamage.GetValue();
        float iceDamage = offensive.iceDamage.GetValue();
        float lightningDamage = offensive.lightningDamage.GetValue();
    ...
    public float GetArmorReduction()
    {
        ...
        float finalReduction = offensive.armorReduction.GetValue() / 100;
    ...
    public Stats GetStatByType(StatType type)
    {
        switch (type)
        {
            ...
            case StatType.AttackSpeed: return offensive.attackSpeed;
    ...
    public void ApplyDefaultStatSetup()
    {
        ...
        offensive.attackSpeed.SetBaseValue(defaultStatSetup.attackSpeed);
        offensive.damage.SetBaseValue(defaultStatSetup.damage);
